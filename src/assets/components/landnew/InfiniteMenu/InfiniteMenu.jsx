  ...
  return (
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        ...
        `}
          >
            <h2 className="font-black [font-size:4rem] text-white font-['Chakra_Petch'] bg-gradient-to-r from-white to-neutral-300 bg-clip-text text-transparent">
              {activeItem.title.split('\n').map((line, i) => (
                <React.Fragment key={i}>
                  {line}
                  {i < activeItem.title.split('\n').length - 1 && <br />}
                </React.Fragment>
              ))}
            </h2>
          </div>
        ...
        `}
          >
            <p className="text-[1.5rem] text-neutral-300 font-['Chakra_Petch'] break-words hyphens-auto">
              {activeItem.description}
            </p>
            <div className="w-full h-1 mt-3 bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent rounded-full"></div>
          </div>
        ...
        `}
          >
            <span className="select-none text-white font-medium font-['Chakra_Petch'] text-sm">
              EXPLORE
            </span>
            <span className="select-none text-white text-[18px] font-bold font-['Chakra_Petch']">
              &#x2197;
            </span>
          </div>
        </>
