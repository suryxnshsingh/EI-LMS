  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold text-white">
        Learning Management <br /> Made Easy
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-gray-200">
        An end-to-end learning management system for Electronics & Instrumentation 
        education featuring course analytics, virtual labs, attendance tracking, 
        quiz engines, assignment portals, and AI-powered learning tools.
      </p>
    </div>
  );
};
...
export const ProductCard = ({ product, translate }) => {
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-64 w-[20rem] md:h-96 md:w-[30rem] relative shrink-0 rounded-xl overflow-hidden"
    >
      <a
        href={product.link}
      ...
      >
        <img
          ...
          height="600"
          width="600"
          className="object-cover object-center absolute h-full w-full inset-0 transition-transform duration-300 group-hover/product:scale-110"
          alt={product.title}
        />
      </a>
